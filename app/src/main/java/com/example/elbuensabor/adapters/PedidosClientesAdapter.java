...
public class PedidosClientesAdapter extends RecyclerView.Adapter<PedidosClientesAdapter.ViewHolder>{
    private List<HistorialPedido> pedidoList;
    private Context context;

    public PedidosClientesAdapter(List<HistorialPedido> pedidoList, Context context) {
    ...
    @NonNull
    @Override
    public PedidosClientesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view ;
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(view).navigate(R.id.nav_pedido_cliente_detalle,bundle);
    ...
    @Override
    public void onBindViewHolder(@NonNull PedidosClientesAdapter.ViewHolder holder, int position) {
